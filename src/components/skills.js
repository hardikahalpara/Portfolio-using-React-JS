  ...
  render() {
    return (
      <div className="skillsContainer" >
        ...
        <p style={{ top: '17.5%', left: '42%' }} class="htmltags">&lt;/h1&gt;</p>
        ...
        <div className="skillsTitle">What am I good at :</div>
        <div>
          ...
          <div class="skills" id="skill-2" style={{ left: '41%', top: '47.9%' }}>
          ...
          <div class="skills" id="skill-3" style={{ left: '70%', top: '44.2%' }}>
          ...
          <div class="skills" id="skill-4" style={{ left: '12%', top: '110%' }}>
          ...
          <div class="skills" id="skill-5" style={{ left: '41%', top: '95.4%' }}>
